...
/***/ function(module, exports, __webpack_require__) {
	...
	Show = __webpack_require__(147);

	Index = React.createClass({
	  render: function() {
	    var items;
	    items = [["1", "2"], ["a", "b"], ["b", "a"]].map(function(pair) {
	      return new Show({
	        text1: pair[0],
	        text2: pair[1]
	      });
	    });
	    return R.div(null, items);
	  }
	});

	$(function() {
	  return React.renderComponent(new Index(null), document.getElementById("app"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeTextForBrowser = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  render: function() {
	    return R.li(null, R.p(null, this.props.text1));
	  }
	});
